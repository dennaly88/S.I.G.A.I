...
<div class="col-md-6 py-3 text-md-center">
            <a href="#" class="btn btn-outline-primary">FINANCIAMIENTO<span class="mai-arrow-forward ml-2"></span></a>   
    <br> <br>
  </div>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="table-responsive">        
                <table id="tablaFinanciamiento" class="table table-striped table-bordered table-condensed" style="width:100%" >
...
<div class="modal fade" id="modalCRUD12" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="btn-sm btn-primary  modal-header">
                ...
                <button type="button" class="btn-sm btn-light" data-dismiss="modal">Financiamiento</button>
                </h5>
        ...
        <form id="formFinanciamiento">    
            <div class="modal-body">
                <div class="row">
                            ...
                            <label for="" class="col-form-label">OPcion</label>
  ...
  <script src="js/financiamiento.js"></script>  
</html>
