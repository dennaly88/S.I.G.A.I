...
<div class="col-md-6 py-3 text-md-center">
            <a href="#" class="btn btn-outline-primary">GERENCIAS<span class="mai-arrow-forward ml-2"></span></a>   
    <br> <br>
  </div>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="table-responsive">        
                <table id="tablaGerencia" class="table table-striped table-bordered table-condensed" style="width:100%" >
        ...
        <form id="formGerencia">    
            <div class="modal-body">
                <div class="row">
                            ...
                            <label for="" class="col-form-label">Nombre de la Gerencia:</label>
