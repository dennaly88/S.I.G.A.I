...
<div class="col-md-6 py-3 text-md-center">
            <a href="#" class="btn btn-outline-primary">MARCAS<span class="mai-arrow-forward ml-2"></span></a>   
    <br> <br>
  </div>
...
<div class="modal fade" id="modalCRUD10" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="btn-sm btn-primary  modal-header">
                <h5  id="exampleModalLabel">

                <button type="button" class="btn-sm btn-light" data-dismiss="modal">Marca</button>
                </h5>
