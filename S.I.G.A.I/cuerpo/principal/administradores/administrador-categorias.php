...
<div class="col-md-6 py-3 text-md-center">
            <a href="#" class="btn btn-outline-primary">CATEGORIAS<span class="mai-arrow-forward ml-2"></span></a>   
    <br> <br>
  </div> 
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="btn-sm btn-primary  modal-header">
                ...
                <button type="button" class="btn-sm btn-light" data-dismiss="modal">Categoria</button>
                </h5>
