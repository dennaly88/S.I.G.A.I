$(document).ready(function() {
    ...
    tablaUsuarios = $('#tablaMarcas').DataTable({  
        "ajax":{            
            "url": "sql/marca.php", 
            "method": 'POST',         
            "data":{opcion:opcion},   
        ...
        clasificacion = $.trim($('#clasificacion').val());  
            ...
            $.ajax({
              ...
              success: function(data) {
                ...
                var respuesta =  alert("Marcas Actualizadas");
               }
            });			        
        $('#modalCRUD10').modal('hide');											     			
    });
    ...
    $(document).on("click", ".btnEditar", function(){		        
        ...
        $('#modalCRUD10').modal('show');	
        var respuesta =  alert("Quieres Editar la Marca");  	   
    });
    $(document).on("click", ".btnBorrar", function(){
        ...
        var respuesta = confirm("¿Está seguro de borrar la Marca "+ id+ "?");    
        if (respuesta) {            
            $.ajax({
              url: "sql/marca.php",
              type: "POST",
              ...
              success: function() {
                  ...
                  var respuesta =  alert("Se Elimino la Marca de Forma Correcta");         
               }
